...
~~~bash
npm install hapi-swagger --force
~~~

The `---force` switch is required here due to version incompatibilities. Joy has been updated recently, but hapi-swagger has yet to catch up.
