...
However, this function - and a set of related functions if we need them, is available as a library:

- <https://www.npmjs.com/package/uuid>

You are used to using npm modules within node applications. However, Front-End frameworks can also use this ecosystem, with the various bundling/packaging tools combining the modules for client side development.

Start by installing the module in the usual way:
